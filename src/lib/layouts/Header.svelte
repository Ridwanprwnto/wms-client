		...
		<div class="flex items-center justify-between w-full">
			...
			<div class="flex items-center flex-1 space-x-4">
				...
				<button
					...
					class="cursor-pointer inline-flex items-center p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 transition-colors"
